...
const Signup = () => {
  ...
  const notifyWarning = () =>
    toast.warning("Your ID or Password is incorrect!", {
  ...
  const submitHandler = async (e) => {
    ...
    e.preventDefault();
    await axios
      .post("http://localhost:3001/signup", { email, name, password })
      .then((result) => {
        console.log(result);
        notifySuccess();
      })
            ...
            <div>
              <div className="w-96 h-auto rounded-lg my-auto p-10  bg-slate-300">
                ...
                <div className="flex justify-center">
                  <button type="submit">
                    <p className="p-2 my-4 border-2 border-blue-500 rounded-lg w-32 transition-colors hover:bg-blue-500 hover:text-white ">
                      Signup
                    </p>
                  </button>
                </div>
