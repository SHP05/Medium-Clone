...
const UpdatePost = () => {
  ...
  const updatePostHandler = async (e) => {
    e.preventDefault();
    await axios
      .put(`http://localhost:3001/updatepost`, {
        pid,
        desc,
        title,
        shortDesc,
  ...
  const uploadPostImg = async (e) => {
    ...
    axios
      .put(`http://localhost:3001/uploadcoverimg/${pid}`, formdata, {
      ...
      <section className="bg-gray-950">
        <div className="flex bg-gray-950 h-full">
          <div className="bg-gray-950 grow mx-20">
            <h1 className="text-white text-3xl bg-gray-950 font-bold text-center p-3">
              📃 Update Your Post 📃
            </h1>
            <form
            ...
            <form
              className="bg-gray-950 text-lg flex"
            ...
            >
              <div className="grid gap-6 mb-6 md:grid-cols-1 mx-auto w-2/3 border rounded-lg p-3 border-gray-500 shadow-2xl">
                ...
                >
                  ...
                  <option value="Gaming" className="bg-slate-800">
                    Gaming
                  </option>
                  <option value="Cripto" className="bg-slate-800">
                    Cripto
                  </option>
                  <option value="Hobbies" className="bg-slate-800">
                    Hobbies
                  </option>
