        ...
        <>
            <div className="flex my-10 mx-4 p-5 justify-center slider">
                <ul className='flex-col justify-center bg-[#191c24] rounded-3xl'>
                    <li className="my-10 hover:bg-stone-100/20 p-3 rounded-full" onClick={()=>navigate(`/home/${id}`)}><i className="fa-solid fa-house fa-xl icon" style={{color:"white", }}></i></li>   {/*#737373*/}
